...
1. Go to the [{{site.data.keyword.cloud_notm}} Cloud Foundry dashboard](https://cloud.ibm.com/resources?filter=cf_environments) and open the {{site.data.keyword.cfee_full_notm}} where you want to manage resource usage.
